...
-----------
    ...
    # Merge directly into your RMM_PARAMS:
    RMM_PARAMS.update(result.best_params())
...
class OptimiserResult:
    ...
    def best_params(self) -> Dict[str, float]:
        """Return ``{"stability_threshold": <best>}`` ready to merge into RMM_PARAMS."""
...
def _print_report(opt: OptimiserResult) -> None:
    ...
    print()
    print(f"    To apply:  RMM_PARAMS['stability_threshold'] = {b.threshold:.2f}")
    print("  " + "═" * 58)
    print()
...
if __name__ == "__main__":
    ...
    print()
    print(f"Apply:  RMM_PARAMS['stability_threshold'] = {result.best.threshold:.2f}")
